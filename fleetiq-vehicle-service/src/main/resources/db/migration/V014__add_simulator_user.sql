...
VALUES 
  ...
  ('77777777-0000-0000-0000-000000000002', 'fuel:create', 'fuel', 'create', 'Used by simulator to create fuel events'),
  ('77777777-0000-0000-0000-000000000003', 'health:create', 'health', 'create', 'Used by simulator to create health events')
ON CONFLICT (code) DO NOTHING;

INSERT INTO role_permissions (role_id, permission_id)
SELECT '66666666-0000-0000-0000-000000000000', id FROM permissions 
WHERE code IN ('vehicles:update', 'fuel:create', 'health:create')
ON CONFLICT DO NOTHING;
